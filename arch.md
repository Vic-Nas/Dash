...
- **livesPerPlayer** (IntegerField, default=0) - 0 means instant death on wall hit (deprecated - now uses score system)
- **wallSpawnInterval** (IntegerField, default=5) - seconds between wall spawns
- **allowExtraLives** (BooleanField, default=False) - deprecated
- **maxExtraLives** (IntegerField, default=2) - deprecated
- **extraLifeCost** (DecimalField, default=5) - deprecated
...
- **extraLivesPurchased** (IntegerField, default=0) - deprecated
- **livesRemaining** (IntegerField, default=0) - deprecated
